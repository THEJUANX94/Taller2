...
export const messages = {
  es: {
    ...
    student: {
      ...
      join: "Unirme / Validar",
      joining: "Validando código…",
      joinedOk: "¡Te has unido a la sesión!",
    ...
    errors: {
      ...
      invalidCodeServer: "El código no existe o la sesión ya cerró.",
      emptyCode: "Ingresa un código para unirte.",
      shortCode: "Código incompleto (mínimo 6 dígitos).",
      onlyNumbers: "Solo se permiten números.",
      tempJoinSession: "Error de red al unirse. Intenta de nuevo.",
    },
  },
  ...
  en: {
    ...
    student: {
      ...
      join: "Join / Validate",
      joining: "Validating code…",
      joinedOk: "You've successfully joined!",
    ...
    errors: {
      ...
      invalidCodeServer: "The code does not exist or the session is closed.",
      emptyCode: "Enter a code to join.",
      shortCode: "Incomplete code (minimum 6 digits).",
      onlyNumbers: "Only numbers are allowed.",
      tempJoinSession: "Network error joining. Please try again.",
    },
  },
};
